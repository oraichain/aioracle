...
## Run app dev staging
- Create file `.env.mongo` into folder `infrastructure/staging/`
...
- Chạy interval process: Vào file interval.yml, thay đổi `image` trùng với tên image của file docker-compose vừa build (cùng source code với server, chỉ khác câu command). Sau đó run docker: `docker-compose -f interval.yml up -d`
