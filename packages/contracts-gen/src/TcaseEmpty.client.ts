...
import {AssertResponse, ExecuteMsg, GetOwnerResponse, GetTestCasesResponse, InstantiateMsg, QueryMsg} from "./TcaseEmpty.types";
...
export interface TcaseEmptyInterface extends TcaseEmptyReadOnlyInterface {
  contractAddress: string;
  sender: string;
  setOwner: ({
    owner
...
export class TcaseEmptyClient extends TcaseEmptyQueryClient implements TcaseEmptyInterface {
